    ...
    <div className="workshop-presets">
      <div className="workshop-presets__head">
        ...
        <p className="workshop-presets__hint">
          Saved locally in this browser (localStorage) — face, settings, and
          active plugins.
        </p>
      </div>
            ...
            <li key={p.name} className="workshop-presets__row">
              <div className="workshop-presets__meta">
                ...
                <span className="workshop-presets__sub">
                  {faceLabel(p.faceId)} · {p.enabledPlugins.length} plugin
                  {p.enabledPlugins.length === 1 ? "" : "s"} ·{" "}
      ...
      <header className="lab-header">
        <div>
          ...
          <p className="lab-header__sub">
            Pick a player face, tune its properties in the panel, toggle
            plugins, and save the result as a local preset. Every preview is the
            real production component playing the No Luck release.
          </p>
        </div>
