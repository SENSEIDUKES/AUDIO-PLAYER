...
export function PluginManagerPanel() {
    const { available, installed, install, uninstall, toggleActive, activeInstances } =
        usePluginRegistry()
                                    ...
                                    isConfirming ? (
                                        ...
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="lab-plugin-card__btn lab-plugin-card__btn--uninstall"
                                                onClick={() =>
                                                    setConfirmUninstallId(record.entry.id)
                                                }
    ...
    return (
        <div className="lab-plugin-manager__section">
            <div className="lab-plugin-manager__section-head">
                <span className="lab-plugin-manager__section-title">{title}</span>
...
function PluginCard({
    ...
    return (
        <div className={`lab-plugin-card${active ? " lab-plugin-card--active" : ""}`}>
            <div className="lab-plugin-card__body">
                <div className="lab-plugin-card__head">
                    ...
                    {entry.category && (
                        <span className="lab-plugin-card__category">{entry.category}</span>
                    )}
                </div>
