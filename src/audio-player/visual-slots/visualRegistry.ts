import type { AnyVisualComponentDefinition, VisualComponentDefinition, VisualSlot } from "./types"
...
export function registerVisualComponent<S>(definition: VisualComponentDefinition<S>): void {
...
export function getVisualComponentsForSlot(slot: VisualSlot): AnyVisualComponentDefinition[] {
